...
// Instagram Feed Component (moved to bottom)
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {instagramPosts.slice(0, 6).map(({ node }, i) => {
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-white/70 max-w-2xl mx-auto mb-8">
                            Living record of our work in progress. Raw footage, field notes, and the moments between takes.
                        </p>
                        <a
                    ...
                    {isLoading ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-white/70">Loading recent work...</p>
                        </div>
                    ) : (
                        <InstagramFeed
