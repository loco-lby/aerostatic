...
export default function MediaGalleryWithPaywall() {
  ...
  const loadPackageData = async () => {
    try {
      // For static site, create demo data
      if (accessCode === '123456') {
        const demoPackage = {
          id: 'demo-package',
          access_code: accessCode,
          flight_date: '2024-01-15',
          passenger_names: ['Demo User'],
        ...
        const demoItems = [
          {
            id: 'demo-1',
            file_url: '/images/demo-photo.jpg',
            file_type: 'photo' as const,
            file_name: 'balloon-sunrise.jpg',
            file_size: 2048576,
            thumbnail_url: '/images/demo-photo.jpg',
            width: 1920,
            height: 1080,
            duration: null,
            download_count: 0
        ...
        router.push('/technologies/aeromedia')
        return
      }
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <Link href="/technologies/aeromedia">
