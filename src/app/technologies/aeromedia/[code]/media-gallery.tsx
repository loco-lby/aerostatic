...
export function MediaGallery({ mediaPackage, groupedMedia, accessCode }: MediaGalleryProps) {
  ...
  const trackDownload = async (mediaItemId: string) => {
    // Download tracking removed for static site
    console.log('Download tracked for:', mediaItemId)
  }
  ...
  const shareGallery = async () => {
    const url = `${window.location.origin}/technologies/aeromedia/${accessCode}`
